...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        if(CheckDuplicateBindings(action, bindingIndex, allCompositeParts))
                        {
                            ...
                            Debug.Log("Rebind canceled due to duplicate binding.");
                            return;
                        }
        ...
        [Tooltip("Optional string field which allows you to OVERRIDE the action label with your own text")]
        [SerializeField]
        ...
        private void UpdateActionLabel()
        {
            if (m_ActionLabel != null)
            {
                ...
                m_ActionLabel.text = m_OverrideActionLabel ? m_ActionLabelString : (action != null ? action.name : string.Empty);
            }
        }
